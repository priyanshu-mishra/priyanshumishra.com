...
const footerLinks = [
  {
    title: 'Github',
    href: 'https://github.com/priyanshu-mishra',
  },
  {
    title: 'LinkedIn',
    href: 'https://www.linkedin.com/in/priyanshu-mishra-/',
  },
  {
    title: 'Instagram',
    href: 'https://www.instagram.com/priyanshu.mishra_/',
  },
  {
    title: 'Twitter',
    href: 'https://x.com/PriyanshuM_',
  },
]
    ...
    <footer className="relative z-10 overflow-x-clip">
      ...
      <div className="container">
        <div className="border-t border-white/15 py-6 text-sm flex flex-col md:flex-row md:justify-between items-center gap-8">
          <div className="text-white/60">&copy; 2024 Priyanshu Mishra.</div>
